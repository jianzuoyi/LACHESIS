...
DIR=/its1/GB_BT2/jianzuoyi/pipeline/biosoft/01.Assembly/LACHESIS/LACHESIS/src/bin # This directory should contain PreprocessSAMs.pl.
...
SAMs="/its1/GB_BT2/jianzuoyi/pipeline/biosoft/01.Assembly/sim3C/03.LACHESIS/test_case/SAMs/sim.hic.raw.bam"
