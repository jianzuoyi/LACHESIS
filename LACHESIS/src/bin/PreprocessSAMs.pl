...
my $make_bed_around_RE_site_pl = '/its1/GB_BT2/jianzuoyi/pipeline/biosoft/01.Assembly/LACHESIS/LACHESIS/src/bin/make_bed_around_RE_site.pl';
#my $bedtools = '/net/shendure/vol10/jnburton/extern/BEDTools-Version-2.15.0/bin/bedtools';
my $bedtools = '/its1/GB_BT2/jianzuoyi/biosoft/anaconda/bin/bedtools';
#my $samtools = '/net/gs/vol3/software/modules-sw/samtools/0.1.18/Linux/RHEL6/x86_64/bin/samtools';
my $samtools = '/its1/GB_BT2/jianzuoyi/biosoft/anaconda/envs/old/bin/samtools';
#my $mem = "16G";
